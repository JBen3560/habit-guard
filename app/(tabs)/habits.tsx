            ...
            <SafeAreaView style={[s.modalSafe, { backgroundColor: C.bg }]}>
                ...
                <View style={[s.modalHeader, { borderBottomColor: C.border, backgroundColor: C.card }]}>
                    <TouchableOpacity onPress={onClose} style={s.modalCloseBtn}>
                        <Text style={[s.modalCloseText, { color: C.sub }]}>✕</Text>
                    </TouchableOpacity>
                    ...
                    >
                        ...
                        <View style={s.categoryGrid}>
                            {CATEGORIES.map((cat) => {
                                ...
                                return (
                                    ...
                                    >
                                        <Text style={s.catCardIcon}>{CATEGORY_ICONS[cat]}</Text>
                                        <Text
                                            style={[
                                                s.catCardText,
                                                { color: C.sub },
                        ...
                        {initial && onDelete && (
                            <TouchableOpacity style={s.deleteBtn} onPress={onDelete}>
                                <Text style={[s.deleteBtnText, { color: C.red }]}>🗑 Delete Habit</Text>
                            </TouchableOpacity>
                        )}
                    ...
                    <View style={s.emptyState}>
                        ...
                        <Text style={[s.emptySub, { color: C.sub }]}>
                            {filter === 'Pending'
                                ...
                                : 'Switch filter or add a new habit'}
                        </Text>
                    </View>
                )}
                {filtered.map((task) => {
...
const s = StyleSheet.create({
    ...
    miniStatLabel: { fontSize: 9, fontWeight: '700', marginTop: 1, letterSpacing: 0.5 },
    ...
    timeCardLabel: { fontSize: 13, fontWeight: '600' },
