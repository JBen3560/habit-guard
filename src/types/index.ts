...
export const INITIAL_TROPHIES: Trophy[] = [
  ...
  },
  {
    ...
    description: '10-day water streak',
    icon: '💧',
    type: 'streak',
    earned: true,
    earnedDate: 'Mar 15',
  ...
  },
  {
    id: 't6',
    title: 'Slacker',
    description: 'Skipped all tasks in a day',
    icon: '😴',
    type: 'bad',
    earned: false,
  },
  ...
  },
  {
    ...
    description: 'Ended streak of at least 7 days',
    icon: '⛓️‍💥',
    type: 'bad',
    earned: true,
  },
  {
    id: 't9',
    title: 'Gone Missing',
    description: 'Skipped all tasks in a week',
    icon: '🫥',
    type: 'bad',
    earned: false,
  },
